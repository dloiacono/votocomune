...
import { Menu, X, LogOut, BarChart3, Users, FileText, User } from 'lucide-react'
...
export default function Layout({ children }) {
  ...
  const menuItems = [
    ...
    {
      label: 'Inserimento Voti',
      path: '/voti',
      icon: FileText,
      show: isGestoreVoti || isAdmin
    },
    {
      label: 'Sezioni',
      path: '/sezioni',
    ...
    },
    {
      ...
      path: '/liste',
      icon: FileText,
      show: isAdmin || isGestoreListe
    },
    {
      label: 'Candidati Sindaci',
      path: '/candidati/sindaci',
      icon: User,
      show: isAdmin || isGestoreCandidati
    },
    {
      label: 'Candidati Consiglieri',
      path: '/candidati/consiglieri',
      icon: Users,
      show: isAdmin || isGestoreCandidati
    },
    {
